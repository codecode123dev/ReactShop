                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-light">
                    <div className="nav-brand">
                        <i className="fa fa-bars header-bars-icons" aria-hidden="true"></i>
                            <img className="img-constructor" src={Icons.constructor} alt="constructor" onClick={goToHome}/>
                    </div>
                        ...
                        <div className="right-icons ">
                            <div className="account">
                                <a href={url} className="account-item">
                                    ...
                                    <a className="account-content" href={url} onClick={handleChangeRouter}>Account</a>
                                </a>
                            </div>
